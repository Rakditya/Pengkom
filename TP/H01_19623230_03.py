...
if(Nomor_Kursi <= 1 and Nomor_Kursi <=20) or (Nomor_Kursi <=51 and Nomor_Kursi <=60) and Posisi_Kursi == "A" or Posisi_Kursi == "F":
    harga = 1600000
elif(Posisi_Kursi == "B" or Posisi_Kursi == "E"):
    harga = 1550000
elif(Posisi_Kursi == "C" or Posisi_Kursi == "D"):
    harga = 1500000
elif(Nomor_Kursi <= 21 and Nomor_Kursi <=50) or (Nomor_Kursi <=61 and Nomor_Kursi <=100) and Posisi_Kursi == "A" or Posisi_Kursi == "F":
    harga = 1000000
elif(Posisi_Kursi == "B" or Posisi_Kursi == "E"):
    harga = 950000
