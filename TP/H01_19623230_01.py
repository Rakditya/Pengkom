...
if(nilai_ujian_1 or nilai_ujian_2 or nilai_ujian_3 or nilai_ujian_4 >=50) and ratarata_nilai >=70:
    status = 'lulus'
else: # nilai_ujian_1 or nilai_ujian_2 or nilai_ujian_3 or nilai_ujian_4 <= 50 or60 ratarata_nilai >=70:
